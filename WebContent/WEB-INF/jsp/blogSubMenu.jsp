...
function fillColor(){
	for(i=1;i<=4;i++){
		...
		img.style.backgroundColor  = '#002185';
	}
}
...
<tr><td><img src="<%=request.getContextPath() %>/images/ideal.png" id="4" width="70" height="25" 
 ...
 -->
<table>
<tr><td><a href="BGI.do?isNew=yes" target="subcontent">New Blog</a> </td></tr>
<tr><td><a href="BGL.do" target="subcontent">Edit Blog</a></td></tr>
<tr><td><a href="" target="">settings</a></td></tr>
</table>
</form>
</body>
</html>