...
<body>
<html:form enctype="multipart/form-data" method="POST" action="BK.do" onsubmit="return validateIdeal(this);">
...
<br>
<div class="label">Suggest your Book</div>
...
<tr>
	<td>Book title</td>
	<td>:</td>
	<td><html:text property="btitle"/></td>
</tr>
<tr>
	<td>Select Book Icon</td>
	<td>:</td>
	<td><html:file disabled="false" property="bicon"></html:file></td>
</tr>
<tr>
	<td>Select Book</td>
	<td>:</td>
	<td><html:file disabled="false" property="book"></html:file></td>
</tr>
<tr>
	<td>Author</td>
	<td>:</td>
	<td>
	<html:textarea property="bauthor" cols="55" rows="10"></html:textarea>
	</td>
</tr>
